...
-- ----------------------------
-- Table structure for agency_scope
-- ----------------------------
DROP TABLE IF EXISTS `agency_scope`;
CREATE TABLE `agency_scope`  (
...
-- ----------------------------
-- Table structure for area_boundaries
-- ----------------------------
...
-- ----------------------------
-- Table structure for courier_scop
-- ----------------------------
DROP TABLE IF EXISTS `courier_scop`;
CREATE TABLE `courier_scop`  (
  `id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
-- ----------------------------
-- Table structure for transport_line
-- ----------------------------
...
-- ----------------------------
-- Table structure for transport_line_type
-- ----------------------------
DROP TABLE IF EXISTS `transport_line_type`;
CREATE TABLE `transport_line_type`  (
  `id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'id',
...
-- ----------------------------
-- Table structure for transport_trips
-- ----------------------------
...
-- ----------------------------
-- Table structure for transport_trips_truck_driver
-- ----------------------------
DROP TABLE IF EXISTS `transport_trips_truck_driver`;
CREATE TABLE `transport_trips_truck_driver`  (
  `id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'id',
...
-- ----------------------------
-- Table structure for truck_driver_license
-- ----------------------------
DROP TABLE IF EXISTS `truck_driver_license`;
CREATE TABLE `truck_driver_license`  (
  `id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `user_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '用户id',
...
-- ----------------------------
-- Table structure for truck_license
-- ----------------------------
DROP TABLE IF EXISTS `truck_license`;
CREATE TABLE `truck_license`  (
  `id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'id',
  `truck_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '车辆id',
...
-- ----------------------------
-- Table structure for truck_type_goods_type
-- ----------------------------
DROP TABLE IF EXISTS `truck_type_goods_type`;
CREATE TABLE `truck_type_goods_type`  (
  `id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
