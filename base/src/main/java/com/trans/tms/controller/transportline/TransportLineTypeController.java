...
public class TransportLineTypeController {
    ...
    public PageResponse<TransportLineTypeDto> findByPage(@RequestParam(name = "page") Integer page,
        ...
        return PageResponse.<TransportLineTypeDto>builder().items(dtoList).size(pageSize).current(page)
                .counts(transportLineTypePage.getTotal()).total(transportLineTypePage.getPages()).build();
    }
