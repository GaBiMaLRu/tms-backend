package com.trans.tms.controller.truck;
...
import com.trans.tms.entity.truck.PdTruckType;
import com.trans.tms.entity.truck.PdTruckTypeGoodsType;
import com.trans.tms.service.truck.IPdTruckTypeGoodsTypeService;
import com.trans.tms.service.truck.IPdTruckTypeService;
...
public class TruckTypeController {
    ...
    public PageResponse<TruckTypeDto> findByPage(@RequestParam(name = "page") Integer page,
        ...
        return PageResponse.<TruckTypeDto>builder().items(dtoList).size(pageSize).current(page)
                .counts(pdTruckTypePage.getTotal()).total(pdTruckTypePage.getPages()).build();
    }
