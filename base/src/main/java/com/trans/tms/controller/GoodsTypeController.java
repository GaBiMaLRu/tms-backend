...
import com.trans.tms.service.base.IPdGoodsTypeService;
...
public class GoodsTypeController {
    ...
    public PageResponse<GoodsTypeDto> findByPage(@RequestParam(name = "page") Integer page,
        ...
        if(goodsTypePageRecords != null && goodsTypePageRecords.size() > 0){
            ...
            return PageResponse.<GoodsTypeDto>builder().items(goodsTypeDtoList).counts(goodsTypePage.getTotal()).current(page).total(goodsTypePage.getPages()).size(pageSize).build();
        }
