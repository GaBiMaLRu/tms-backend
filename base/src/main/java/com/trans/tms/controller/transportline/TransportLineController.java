package com.trans.tms.controller.transportline;
...
import com.trans.tms.entity.transportline.PdTransportLine;
import com.trans.tms.service.transportline.IPdTransportLineService;
...
public class TransportLineController {
    ...
    public PageResponse<TransportLineDto> findByPage(@RequestParam(name = "page") Integer page,
        ...
        return PageResponse.<TransportLineDto>builder().items(dtoList).size(pageSize).current(page)
                .counts(transportLinePage.getTotal()).total(transportLinePage.getPages()).build();
    }
