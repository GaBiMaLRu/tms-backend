package com.trans.tms.controller.user;
...
public class DriverController {
    ...
    public PageResponse<TruckDriverDto> findByPage(@RequestParam(name = "page") Integer page,
        ...
        return PageResponse.<TruckDriverDto>builder().items(dtoList).size(pageSize).current(page).counts(truckPage.getTotal())
                .total(truckPage.getPages()).build();
    }
