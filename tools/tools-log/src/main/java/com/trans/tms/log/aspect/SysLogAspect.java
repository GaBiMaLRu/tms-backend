package com.trans.tms.log.aspect;
...
import com.trans.tms.log.event.SysLogEvent;
import com.trans.tms.log.util.LogUtil;
...
public class SysLogAspect {
     ...
     */
    @Pointcut("@annotation(com.trans.tms.log.annotation.SysLog)")
