...
public class JwtHelperTest {
    ...
    public static void main(String[] args) throws Exception {
        JwtUserInfo jwtInfo = new JwtUserInfo(1L, "tms", "品达", 1L, 1L);
        int expire = 7200;

        //生成Token  注意： 确保该模块 tools-jwt-starter/src/main/resources 目录下已经有了私钥
        Token token = JwtHelper.generateUserToken(jwtInfo, "pri.key", expire);
        System.out.println(token);

        //解析Token  注意： 确保该模块 tools-jwt-starter/src/main/resources 目录下已经有了公钥
