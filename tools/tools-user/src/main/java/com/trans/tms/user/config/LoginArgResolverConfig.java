package com.trans.tms.user.config;

import java.util.List;
import com.trans.tms.user.feign.UserResolveApi;
import com.trans.tms.user.interceptor.ContextHandlerInterceptor;
import com.trans.tms.user.resolver.ContextArgumentResolver;
