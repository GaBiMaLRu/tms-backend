package com.trans.tms.database.properties;
...
import static com.trans.tms.database.properties.DatabaseProperties.PREFIX;
/**
 * 客户端认证配置
 */
...
public class DatabaseProperties {
    public static final String PREFIX = "tms.database";
    /**
     * 攻击 SQL 阻断解析器
     */
     ...
     * 事务扫描基础包
     */
    private String transactionScanPackage = "com.trans.tms";
}
