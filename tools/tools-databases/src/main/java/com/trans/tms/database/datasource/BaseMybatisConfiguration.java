package com.trans.tms.database.datasource;
...
import com.trans.tms.base.id.IdGenerate;
import com.trans.tms.base.id.SnowflakeIdGenerate;
import com.trans.tms.database.mybatis.typehandler.FullLikeTypeHandler;
import com.trans.tms.database.mybatis.typehandler.LeftLikeTypeHandler;
import com.trans.tms.database.mybatis.typehandler.RightLikeTypeHandler;
import com.trans.tms.database.parsers.TenantWebMvcConfigurer;
...
public abstract class BaseMybatisConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(name = "tms.database.isMultiTenant", havingValue = "true", matchIfMissing = true)
