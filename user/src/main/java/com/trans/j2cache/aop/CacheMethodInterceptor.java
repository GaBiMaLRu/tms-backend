package com.trans.j2cache.aop;

import com.trans.j2cache.annotation.Cache;
import com.trans.j2cache.annotation.CacheEvictor;
import com.trans.j2cache.aop.processor.AbstractCacheAnnotationProcessor;
import com.trans.j2cache.aop.processor.CacheEvictorAnnotationProcessor;
import com.trans.j2cache.aop.processor.CachesAnnotationProcessor;
import com.trans.j2cache.utils.SpringApplicationContextUtils;
...
public class CacheMethodInterceptor implements Interceptor{
     ...
     * @throws Throwable
     */
    @Around("@annotation(com.trans.j2cache.annotation.Cache)")//环绕通知
     ...
     * @throws Throwable
     */
    @Around("@annotation(com.trans.j2cache.annotation.CacheEvictor)")//环绕通知
