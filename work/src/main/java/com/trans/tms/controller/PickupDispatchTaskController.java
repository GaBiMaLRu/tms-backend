...
import com.trans.tms.entity.TaskPickupDispatch;
import com.trans.tms.enums.pickuptask.PickupDispatchTaskAssignedStatus;
import com.trans.tms.service.ITaskPickupDispatchService;
...
public class PickupDispatchTaskController {
    ...
    public PageResponse<TaskPickupDispatchDTO> findByPage(@RequestBody TaskPickupDispatchDTO dto) {
        ...
        return PageResponse.<TaskPickupDispatchDTO>builder().items(dtoList).size(dto.getPageSize()).current(dto.getPage()).counts(orderIPage.getTotal())
