...
import com.trans.tms.DTO.TransportOrderSearchDTO;
import com.trans.tms.common.utils.PageResponse;
import com.trans.tms.entity.TransportOrder;
import com.trans.tms.service.ITransportOrderService;
...
public class TransportOrderController {
    ...
    public PageResponse<TransportOrderDTO> findByPage(@RequestParam(name = "page") Integer page,
        ...
        return PageResponse.<TransportOrderDTO>builder().items(dtoList).size(pageSize).current(page).counts(orderIPage.getTotal())
