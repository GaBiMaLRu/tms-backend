/*
 ...
 Source Schema         : tms_base

 Target Server Type    : MySQL
 Target Server Version : 80029
 File Encoding         : 65001

 Date: 16/07/2023 23:16:09
*/
...
CREATE TABLE `pd_transport_line_type`  (
  ...
  `start_agency_type` int(0) NULL DEFAULT NULL COMMENT '起始地机构类型',
  `end_agency_type` int(0) NULL DEFAULT NULL COMMENT '目的地机构类型',
...
CREATE TABLE `pd_transport_trips`  (
  ...
  `period` tinyint(0) NOT NULL COMMENT '周期，1为天，2为周，3为月',
  `status` tinyint(0) NOT NULL DEFAULT 1 COMMENT '状态  0：禁用   1：正常',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `pd_truck_driver`  (
  ...
  `driving_age` int(0) NULL DEFAULT NULL COMMENT '驾龄',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `pd_truck_driver_license`  (
  ...
  `driver_age` int(0) NULL DEFAULT NULL COMMENT '驾龄',
