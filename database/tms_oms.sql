/*
 ...
 Source Schema         : tms_oms

 Target Server Type    : MySQL
 Target Server Version : 80029
 File Encoding         : 65001

 Date: 16/07/2023 23:15:44
*/
...
CREATE TABLE `order`  (
  ...
  `order_type` tinyint(0) NOT NULL COMMENT '订单类型，1为同城订单，2为城际订单',
  `pickup_type` tinyint(0) NOT NULL COMMENT '取件类型，1为网点自寄，2为上门取件',
  ...
  `payment_method` tinyint(0) NULL DEFAULT NULL COMMENT '付款方式,1.预结2到付',
  `payment_status` tinyint(0) NULL DEFAULT NULL COMMENT '付款状态,1.未付2已付',
...
CREATE TABLE `order_cargo`  (
  ...
  `quantity` int(0) NULL DEFAULT NULL COMMENT '货品数量',
...
-- ----------------------------
-- Table structure for order_location
-- ----------------------------
