...
import com.trans.tms.dto.transportline.TransportLineDto;
import com.trans.tms.dto.transportline.TransportLineTypeDto;
...
import com.trans.tms.authority.enumeration.core.OrgType;
...
import com.trans.tms.dto.base.GoodsTypeDto;
...
import com.trans.tms.dto.user.TruckDriverDto;
import com.trans.tms.dto.user.TruckDriverLicenseDto;
import com.trans.tms.feign.agency.FleetFeign;
import com.trans.tms.feign.common.GoodsTypeFeign;
import com.trans.tms.feign.transportline.TransportLineFeign;
import com.trans.tms.feign.transportline.TransportLineTypeFeign;
import com.trans.tms.feign.transportline.TransportTripsFeign;
import com.trans.tms.feign.truck.TruckFeign;
import com.trans.tms.feign.truck.TruckLicenseFeign;
import com.trans.tms.feign.truck.TruckTypeFeign;
import com.trans.tms.feign.user.DriverFeign;
import com.trans.tms.future.PdCompletableFuture;
import com.trans.tms.util.BeanUtil;
import com.trans.tms.vo.base.angency.AgencySimpleVo;
import com.trans.tms.vo.base.angency.AgencyVo;
import com.trans.tms.vo.base.businessHall.GoodsTypeVo;
import com.trans.tms.vo.base.transforCenter.business.*;
import com.trans.tms.vo.base.userCenter.SysUserVo;
...
@Log
public class TransforCenterBusinessController extends BaseController {
    @Autowired
    ...
    public PageResponse<TruckTypeVo> findTruckTypeByPage(@RequestParam(name = "name", required = false) String name,
        ...
        return PageResponse.<TruckTypeVo>builder().items(truckTypeVoList).current(page).size(pageSize).total(truckTypeDtoPage.getTotal()).counts(truckTypeDtoPage.getCounts()).build();
    }
    ...
    public PageResponse<TransportLineTypeVo> findTransportLineTypeByPage(
        ...
        return PageResponse.<TransportLineTypeVo>builder().items(transportLineTypeVoList).counts(transportLineTypeDtoPage.getCounts()).current(page).size(pageSize).total(transportLineTypeDtoPage.getTotal()).build();
    }
    ...
    public PageResponse<FleetVo> findFleetByPage(
                                                 @RequestParam(name = "name", required = false) String name,
        ...
        return PageResponse.<FleetVo>builder().items(fleetVoList).current(page).size(pageSize).counts(fleetDtoPage.getCounts()).total(fleetDtoPage.getTotal()).build();
    }
    ...
    public PageResponse<TruckVo> findTruckByPage(
        ...
        return PageResponse.<TruckVo>builder().items(truckVoList).current(page).size(pageSize).counts(truckDtoPage.getCounts()).total(truckDtoPage.getTotal()).build();
    }
    ...
    public PageResponse<TransportLineVo> findTransportLineByPage(
                                                                 @RequestParam(name = "name", required = false) String name,
        ...
        return PageResponse.<TransportLineVo>builder().items(transportLineVoList).current(page).size(pageSize).total(transportLineDtoPage.getTotal()).counts(transportLineDtoPage.getCounts()).build();
    }
    ...
    public PageResponse<DriverVo> findDriverByPage(
                                                   @RequestParam(name = "name", required = false) String name,
        ...
        if (StringUtils.isNotEmpty(fleetId)) {
            ...
            pages = truckDriverDtoPage.getTotal();
        ...
        return PageResponse.<DriverVo>builder().items(driverVoList).current(page).size(pageSize).counts(total).total(pages).build();
    }
