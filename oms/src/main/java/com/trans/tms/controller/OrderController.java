...
import com.trans.tms.DTO.OrderLocationDto;
...
import com.trans.tms.service.IOrderService;
...
public class OrderController {
    ...
    public PageResponse<OrderDTO> findByPage(@RequestBody OrderDTO orderDTO) {
        ...
        return PageResponse.<OrderDTO>builder().items(dtoList).size(orderDTO.getPageSize()).current(orderDTO.getPage()).counts(orderIPage.getTotal())
                .total(orderIPage.getPages()).build();
    }
    ...
    public PageResponse<OrderDTO> pageLikeForCustomer(@RequestBody OrderSearchDTO orderSearchDTO) {
        ...
        return PageResponse.<OrderDTO>builder().items(dtoList).size(orderSearchDTO.getPageSize()).current(orderSearchDTO.getPage()).counts(orderIPage.getTotal())
                .total(orderIPage.getPages()).build();
    }
